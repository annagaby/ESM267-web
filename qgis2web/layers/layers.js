...
lyr_MPAs_3.set('fieldImages', {'WDPAID': '', 'WDPA_PID': '', 'PA_DEF': '', 'NAME': '', 'ORIG_NAME': '', 'DESIG': '', 'DESIG_ENG': '', 'DESIG_TYPE': '', 'IUCN_CAT': '', 'INT_CRIT': '', 'MARINE': '', 'REP_M_AREA': '', 'GIS_M_AREA': '', 'REP_AREA': '', 'GIS_AREA': '', 'NO_TAKE': '', 'NO_TK_AREA': '', 'STATUS': '', 'STATUS_YR': '', 'GOV_TYPE': '', 'OWN_TYPE': '', 'MANG_AUTH': '', 'MANG_PLAN': '', 'VERIF': '', 'METADATAID': '', 'SUB_LOC': '', 'PARENT_ISO': '', 'ISO3': '', });
...
lyr_ImportantWetlands_5.set('fieldImages', {'OBJECTID': '', 'nome': '', 'Shape_Leng': '', 'Oportunida': '', 'Classe': '', 'PC': '', 'PF_21': '', 'Shape_Le_1': '', 'Shape_Le_2': '', 'Shape_Area': '', });
lyr_EspecialEnvironments_6.set('fieldImages', {'Nome': '', 'Just_Alvo': '', 'Meta': '', 'Just_Meta': '', 'Ref_Metodo': '', 'Obs': '', 'Fonte': '', 'Sist_Coord': '', 'Shape_Leng': '', 'Shape_Area': '', 'Ano': '', });
